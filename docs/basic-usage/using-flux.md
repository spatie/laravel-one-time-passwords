...
When [Flux](https://fluxui.dev) is installed, the Livewire component will automatically use the [Flux OTP input component](https://fluxui.dev/components/otp-input).
